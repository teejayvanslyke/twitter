...
Gem::Specification.new do |s|
  s.name = %q{teejayvanslyke-twitter}
  s.version = "0.6.11"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["John Nunemaker", "T.J. VanSlyke"]
  s.date = %q{2009-11-02}
  ...
  s.homepage = %q{http://github.com/teejayvanslyke/twitter}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubyforge_project = %q{twitter}
  s.rubygems_version = %q{1.3.5}
  s.summary = %q{wrapper for the twitter api (oauth only), with some modifications}
  s.test_files = [
    "test/test_helper.rb",
     "test/twitter/base_test.rb",
     "test/twitter/httpauth_test.rb",
